...
def main(args):
    ...
    uri = create_mongodb_uri_string(
        args.db_user, args.db_password, args.db_hostname, args.db_port, args.db_authentication, args.ssl
    )
    ...
    if args.backend == "github":
        ...
        try:
            ...
            delete_last_system_data_on_failure(
                "pull_request_system",
                cfg.tracking_url,
                db_user=cfg.user,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-b", "--backend", help="Backend to use for the parsing", default="github", choices=available_backends
    )
    ...
    parser.add_argument(
        "-ll",
        "--log-level",
        help="Log level for stdout (DEBUG, INFO), default INFO",
        default="INFO",
